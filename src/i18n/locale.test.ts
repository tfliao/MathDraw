  ...
  it.each([
    {
      ...
      expected: [
        ...
        'Trimmed picture: 我的 picture.png',
        'Trimmed image: width 20 px × height 40 px.',
    ...
    },
    {
      ...
      expected: [
        ...
        '裁切後的圖片：我的 picture.png',
        '裁切後的圖片：寬 20 像素 × 高 40 像素。',
        '自動格數：16 欄 × 20 列。',
    ...
    expect([
      ...
      messages.trimmedPicture('我的 picture.png'),
      messages.trimmedDimensions(20, 40),
